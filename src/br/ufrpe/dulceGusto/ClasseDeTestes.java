...
public class ClasseDeTestes {
	...
	public static void main(String[] args) throws DadosException, ClienteNaoExisteException {
		...
		System.out.println(fachada.buscaPorCpf("06854395429").getSenha());
		fachada.remover(felipe);
		System.out.println(fachada.buscaPorCpf(felipe.getCpf()));
